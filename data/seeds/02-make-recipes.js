...
const steps = [
  ...
  { instructions: "Heat oven", step_number: 1, recipe_id: 2 },
  {
    instructions: "Put chicken and lemon in oven",
    step_number: 2,
    recipe_id: 2,
  },
  { instructions: "Put in oven at 500 degrees", step_number: 3, recipe_id: 2 },
  {
    instructions: "Fish a salmon in the Bidasoa river",
    step_number: 1,
    recipe_id: 3,
  },
  { instructions: "Cook salmon", step_number: 2, recipe_id: 3 },
];
...
exports.seed = async function (knex) {
  ...
  await knex("steps_ingredients").insert(step_ingredients);
};
